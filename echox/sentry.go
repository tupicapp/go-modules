...
// Sentry returns a middleware that attaches a per-request Sentry hub to the
// echo context and captures any panics before the Recover middleware handles
// them.
...
// GetSentryHub returns the per-request Sentry hub stored in the echo context,
// or nil when Sentry is not configured.
